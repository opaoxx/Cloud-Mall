...
class ElasticsearchProductIndexWriterTest {
    ...
    void deletingMissingDocumentIsIdempotent() throws Exception {
        ...
        doThrow(new ElasticsearchStatusException("missing", RestStatus.NOT_FOUND))
                .when(client).delete(any(DeleteRequest.class), eq(org.elasticsearch.client.RequestOptions.DEFAULT));
        ElasticsearchProductIndexWriter writer = new ElasticsearchProductIndexWriter(client, new ObjectMapper(), "products");
