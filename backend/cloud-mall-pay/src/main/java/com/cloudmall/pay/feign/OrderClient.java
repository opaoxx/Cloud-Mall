...
public interface OrderClient {
  ...
  ApiResponse<OrderView> get(
      @PathVariable("orderNo") String orderNo, @RequestHeader("X-User-Id") Long userId);

  @PostMapping("/api/orders/{orderNo}/paid")
  ApiResponse<OrderView> paid(
      @PathVariable("orderNo") String orderNo, @RequestHeader("X-User-Id") Long userId);
