...
USE cloudmall_user;
CREATE TABLE IF NOT EXISTS mall_user (id BIGINT PRIMARY KEY, username VARCHAR(64) NOT NULL UNIQUE, password_hash VARCHAR(255) NOT NULL, role VARCHAR(16) NOT NULL DEFAULT 'USER', nickname VARCHAR(128), phone VARCHAR(32), avatar_url VARCHAR(512), status TINYINT NOT NULL DEFAULT 1, created_at DATETIME(3) NOT NULL, updated_at DATETIME(3) NOT NULL);
